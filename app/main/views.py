...
def pitches():
    ...
    entertainment = Pitch.query.filter_by(category = 'enterainment').all()
    promotion = Pitch.query.filter_by(category = 'promotion').all()

    title = 'Pitches -  Welcome to The Pitches'
    return render_template('pitches.html', title=title , pitches = pitches, business = business,entertainment = entertainment,promotion = promotion)
...
def addpitches():
    ...
    title = 'Add-Pitch -  Welcome to The Pitches'
